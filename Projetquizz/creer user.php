...
margin-left: 10px;
      ...
      <form class="container mt-1 " style="background-color:#CAE5DB; width:1600px;" >
        
        <div class="containterbottom" style="display: flex;flex-direction: row;">
       
        <div class="container right" style="width: 700px; height:auto;border-radius: 10px; border: solid #0C3A29 1px; display:flex;flex-direction:row;margin-top:21px">
        <div class="right-one">
             
        
            <form class="container mt-5 " style="background-color:#f8fdfd; width:600px;" >
                <h3>S'inscrire</h3>
                <p>Pour tester votre niveau de culture géneral</p>
                ...
                <a name="creer" type="submit"  class="btn col-4 pt-2" href="connection.html" style=" width:200px; background-color:#3addd6 ; margin: 0px 233px 0px 82px;color: #f8fdfd;" role="button">Créer compte</a>
              </form>
        </div>
        <div class="right-deux">
            <img src="avatar.png" class="rounded-circle" style="border:solid #3addd6 2px ;height: 150px; width: 150px; margin: 10px">
            <h4> Avatar User </h4>
        </div>
        </div>
    </div>
